    ...
    try {
        ...
        const initialData = {
            ...
            gameData: {
                ...
                rounds: [
                    { id: 1, name: 'الجولة الأولى (الدابل)', start: '2025-09-28T15:00', end: '2025-10-01T20:00' }
                ],
                matches: [],
                currentRound: 1,
                userTeams: {},
...
app.delete('/api/users/:username', authenticateToken, async (req, res) => {
    try {
        ...
        // حذف من فرق المستخدمين وكل البيانات المرتبطة
        delete data.gameData.userTeams[username];
        delete data.gameData.transfersUsed[username];
        delete data.gameData.powerUpsUsed[username];
        delete data.gameData.activePowerUps[username];
        await writeData(data);
